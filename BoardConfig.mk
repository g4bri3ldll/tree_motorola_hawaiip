...
# Correção dos Headers para o Moto G22 (Android 12 usa Header 2 no boot principal)
...
# Forçar estritamente o Gzip no ramdisk do TWRP e desativar compressões customizadas
BOARD_RAMDISK_COMPRESS := gz
TARGET_RAMDISK_COMPRESS := gz
LZMA_RAMDISK := false
MINIMAL_BUILD := true
TW_INCLUDE_COMPRESSED_RAMDISK := false
PRODUCT_RAMDISK_COMPRESSION := gzip
